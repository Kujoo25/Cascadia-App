...
1. Define the type and Zod schema in `packages/cascadia-commons/src/lib/items/types/`
2. Add database columns in `packages/cascadia-api/src/lib/db/schema/items.ts`
