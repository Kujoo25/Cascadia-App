...
`packages/core/src/lib/events/definitions/work-orders.ts`
...
// packages/core/src/lib/events/definitions/register.ts
// (2) The side-effect import. If the file is new, add it here.
import './work-orders'

// packages/core/src/lib/events/index.ts
...
`packages/core/src/lib/services/WorkOrderService.ts`
